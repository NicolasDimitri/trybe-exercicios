...
// escreva sum abaixo
const sum = (...arg) => arg.reduce((total, numero) => total + numero, 0)
...
const filterPeople = (pessoa) => pessoa.filter(pessoaDoSeculoXX => pessoaDoSeculoXX.bornIn > 1900 && pessoaDoSeculoXX.bornIn < 2000 && pessoaDoSeculoXX.nationality === "Australian" ? pessoaDoSeculoXX : false)
